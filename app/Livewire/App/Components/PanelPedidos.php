...
#[Lazy]
class PanelPedidos extends Component
{
    public $data;
    public $date_ini;
    public $date_fim;
    ...
    {
        return view('livewire.app.components.panel-pedidos');
    }
    ...
    {
        $tiposPedidos = TipoGrupo::query()->where('tenant_id', auth()->user()->tenant_id)->get();
