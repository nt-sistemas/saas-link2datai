...
class ChartDonutFabricanteQuantidade extends LivewireChartComponent
{
    protected $listeners = [];
    public $grupo_id;
    public $dt_inicio;
    ...
    public function getDataChart()
    {
        ...
        $vendas = Venda::query()
            ->selectRaw('fabricante,count(fabricante) as quantidade')
        ...
        foreach ($vendas as $venda) {
            ...
            $chart['data'][] = intval($venda->quantidade) ?? 0;
        }
        return $chart;
    }
